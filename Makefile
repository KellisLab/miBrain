...
all: document source_package binary_package packages install pkgdown #drat

.PHONY: document source_package binary_package packages targets all install pkgdown #drat
